...
@system sys_r1(q::Query((Comp1,))) = begin end
@system sys_r2(q::Query((Comp2,))) = begin end
@system sys_w1(q::Query((Mut(Comp1),))) = begin end
@system sys_w2(q::Query((Mut(Comp2),))) = begin end
@system sys_r1_r2(q::Query((Comp1, Comp2))) = begin end
...
@testset "Parallel Scheduling" begin
    ...
    @testset "Write-Write Conflict" begin
        ...
        @system sys_w1_alt(q::Query((Mut(Comp1),))) = begin end
